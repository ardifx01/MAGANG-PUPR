        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Rumah BMN</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <form>
                <div class="card-body">
                  <div class="form-group">
                    <label for="JumlahPagu">Aset Rusun</label>
                    <input type="number" class="form-control" id="JumlahPagu" placeholder="Input Jumlah Pagu">

                    <label for="JumlahTower">Serah Terima Rusun</label>
                    <input type="number" class="form-control" id="JumlahTower" placeholder="Input Jumlah Tower">

                    <label for="JumlahPagu">Aset Rusus</label>
                    <input type="number" class="form-control" id="JumlahPagu" placeholder="Input Jumlah Pagu">

                    <label for="JumlahTower">Serah Terima Rusus</label>
                    <input type="number" class="form-control" id="JumlahTower" placeholder="Input Jumlah Tower">
